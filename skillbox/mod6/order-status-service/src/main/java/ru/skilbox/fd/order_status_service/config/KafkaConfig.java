package ru.skilbox.fd.order_status_service.config;
...
//        return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(), new JsonDeserializer<>(objectMapper));
        ...
        // Создаем JsonDeserializer с указанием типа OrderEvent
        JsonDeserializer<OrderEvent> jsonDeserializer = new JsonDeserializer<>(OrderEvent.class);
        jsonDeserializer.ignoreTypeHeaders(); // Игнорируем заголовки типа
        jsonDeserializer.trustedPackages("*"); // Доверяем всем пакетам
